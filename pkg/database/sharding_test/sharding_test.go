...
import (
	...
	"github.com/go-chocolate/chocolate/pkg/database/sharding"
	"github.com/go-chocolate/chocolate/pkg/database/sharding/storage"
	"github.com/go-chocolate/chocolate/pkg/database/sharding/strategy"
)
...
func TestSharding(t *testing.T) {
	db, err := orm.OpenMemory(orm.WithStdLogger())
	if err != nil {
		t.Error(err)
	}
